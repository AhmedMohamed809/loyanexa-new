...
export const en = {
  ...
  enrolBirthdayHint: 'Only the day and month are kept â never the year.',
  autoTitle: 'Automated messages',
  autoSubtitle: 'These send on their own. Both are off until you switch them on and write the message.',
  autoBirthdayTitle: 'Birthday',
  autoBirthdayDesc: 'Sends on a customer’s birthday, once a year. Customers are asked for their birthday on the join page only while this is on.',
  autoWinbackTitle: 'Win-back',
  autoWinbackDesc: 'Sends to a customer who has not collected a stamp for a while, and then waits the same period before nudging them again.',
  autoEnableLabel: 'Switch this on',
  autoMessageLabel: 'Message',
  autoWinbackDaysLabel: 'Days without a visit',
  autoSaveButton: 'Save automations',
  autoSaved: 'Automations saved.',
  autoMessageRequired: 'Write a message before switching an automation on.',
