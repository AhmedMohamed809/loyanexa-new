...
export const ar: Record<keyof typeof en, string> = {
  ...
  autoSubtitle: 'تُرسَل هذه الرسائل من تلقاء نفسها. وكلتاهما متوقّفة حتى تُفعّلها وتكتب نصّها.',
  ...
  setupStaff: 'أضف رمزًا سريًّا لموظف',
  setupDoneTitle: 'كل شيء جاهز',
  setupDoneBody: 'اكتمل الإعداد، ولن تظهر هذه اللوحة مرة أخرى.',
  planLimitCards: 'تتضمّن باقتك {limit} بطاقات ولديك {used}. قم بالترقية لإضافة المزيد.',
  planLimitStaff: 'تتضمّن باقتك {limit} رموز موظفين ولديك {used}. قم بالترقية لإضافة المزيد.',
  planLimitStaffNone: 'رموز الموظفين غير متاحة في باقتك. قم بالترقية لإضافتها.',
  planCurrent: 'باقتك',
  ...
  walletStampsLeftLabel: 'طوابع متبقية',
  walletStampsUnit: '{count} طوابع',
