...
export const ar: Record<keyof typeof en, string> = {
  ...
  enrolBirthdayLabel: 'ØªØ§Ø±ÙØ® Ø§ÙÙÙÙØ§Ø¯',
  enrolBirthdayHint: 'ÙØ­ØªÙØ¸ Ø¨Ø§ÙÙÙÙ ÙØ§ÙØ´ÙØ± ÙÙØ· â Ø¯ÙÙ Ø§ÙØ³ÙØ© Ø£Ø¨Ø¯ÙØ§.',
  autoTitle: 'Ø§ÙØ±Ø³Ø§Ø¦Ù Ø§ÙØªÙÙØ§Ø¦ÙØ©',
  autoSubtitle: 'ØªÙØ±Ø³Ù ÙØ°Ù Ø§ÙØ±Ø³Ø§Ø¦Ù ØªÙÙØ§Ø¦ÙÙØ§. ÙÙØ§ÙÙØ§ ÙØªÙÙÙ Ø­ØªÙ ØªÙÙØ¹ÙÙÙ ÙØªÙØªØ¨ Ø§ÙØ±Ø³Ø§ÙØ©.',
  autoBirthdayTitle: 'Ø¹ÙØ¯ Ø§ÙÙÙÙØ§Ø¯',
  autoBirthdayDesc: 'ØªÙØ±Ø³Ù ÙÙ Ø¹ÙØ¯ ÙÙÙØ§Ø¯ Ø§ÙØ¹ÙÙÙ ÙØ±Ø© ÙØ§Ø­Ø¯Ø© Ø³ÙÙÙÙØ§. ÙØ§ ÙÙØ·ÙØ¨ ØªØ§Ø±ÙØ® Ø§ÙÙÙÙØ§Ø¯ ÙÙ ØµÙØ­Ø© Ø§ÙØ§ÙØ¶ÙØ§Ù Ø¥ÙØ§ Ø¹ÙØ¯ ØªÙØ¹ÙÙ ÙØ°Ù Ø§ÙÙÙØ²Ø©.',
  autoWinbackTitle: 'Ø§Ø³ØªØ¹Ø§Ø¯Ø© Ø§ÙØ¹ÙÙØ§Ø¡',
  autoWinbackDesc: 'ØªÙØ±Ø³Ù Ø¥ÙÙ Ø§ÙØ¹ÙÙÙ Ø§ÙØ°Ù ÙÙ ÙØ­ØµÙ Ø¹ÙÙ Ø®ØªÙ ÙÙØ° ÙØªØ±Ø©Ø Ø«Ù ØªÙØªØ¸Ø± Ø§ÙÙØ¯Ø© ÙÙØ³ÙØ§ ÙØ¨Ù ØªØ°ÙÙØ±Ù ÙØ¬Ø¯Ø¯ÙØ§.',
  autoEnableLabel: 'ØªÙØ¹ÙÙ ÙØ°Ù Ø§ÙÙÙØ²Ø©',
  autoMessageLabel: 'Ø§ÙØ±Ø³Ø§ÙØ©',
  autoWinbackDaysLabel: 'Ø¹Ø¯Ø¯ Ø§ÙØ£ÙØ§Ù Ø¯ÙÙ Ø²ÙØ§Ø±Ø©',
  autoSaveButton: 'Ø­ÙØ¸ Ø§ÙØ±Ø³Ø§Ø¦Ù Ø§ÙØªÙÙØ§Ø¦ÙØ©',
  autoSaved: 'ØªÙ Ø­ÙØ¸ Ø§ÙØ±Ø³Ø§Ø¦Ù Ø§ÙØªÙÙØ§Ø¦ÙØ©.',
  autoMessageRequired: 'Ø§ÙØªØ¨ Ø±Ø³Ø§ÙØ© ÙØ¨Ù ØªÙØ¹ÙÙ Ø§ÙØ¥Ø±Ø³Ø§Ù Ø§ÙØªÙÙØ§Ø¦Ù.',
