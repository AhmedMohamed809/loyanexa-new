...
export const ar: Record<keyof typeof en, string> = {
  ...
  designerLocationsGeoBlocked: 'حظر متصفّحك طلب الموقع. اسمح بالوصول إلى الموقع لهذا الموقع، أو الصق رابط خريطة أدناه.',
  designerLocationsGeoInApp: 'خدمة الموقع لا تعمل داخل هذا المتصفّح المدمج. افتح الموقع في Safari أو Chrome، أو الصق رابط خريطة أدناه.',
  designerLocationsGeoUnavailable: 'تعذّر على جهازك تحديد الموقع. حاول قرب نافذة، أو الصق رابط خريطة أدناه.',
  designerLocationsGeoTimeout: 'استغرق الأمر وقتًا طويلًا. حاول مجددًا، أو الصق رابط خريطة أدناه.',
  ...
  designerLocationsPasteOk: 'تم إدخال الإحداثيات أدناه.',
  copyDone: 'تم النسخ',
